...
class SmsController extends Controller
{
    ...
    public function SendSms($mobile_number,$id){


        $code=rand(10000,99999);

        $url="http://ippanel.com:8080/?apikey=sSMk61V2l8H_aj4spFfHH1ENPOc9vOe1euVVpoJHS_I=&pid=4gcf6mcttn&fnum=3000505&tnum=$mobile_number&p1=verification-code&v1=$code";
